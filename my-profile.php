...
$query="update  userregistration set stdid=?,hname=?,sname=?,scname=?,gender=?,blood_group=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssssssssi',$stdid,$hname,$sname,$scname,$gender,$blood,$contactno,$udate,$aid);
$stmt->execute();
...
<label class="col-sm-2 control-label"> Student Register ID : </label>
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" required="required" value="<?php echo $row->stdid;?>" readonly="true">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="hname" id="hname"  class="form-control" value="<?php echo $row->hname;?>"   required="required" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="scname" id="scname"  class="form-control" value="<?php echo $row->SCName;?>" required="required">
</div>
</div>
...
<option value="<?php echo $row->blood_group;?>"><?php echo $row->gender;?></option>
...
<input type="text" name="paddress" id="paddress"  class="form-control" value="<?php echo $row->permanent_address;?>" required="required"> 
</div>
</div> 
